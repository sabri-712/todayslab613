...
const fadeaway = ()=>{
    let eyes = document.querySelector('.wink')
    eyes.classList.toggle('shrink')
}




// move witch from one side to the next, on the click of button beneath
const fly = ()=>{
    let fly = document.querySelector('ring')
}